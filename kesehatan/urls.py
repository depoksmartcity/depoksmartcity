...
from .views import show_main, registrasi, show_healthFacility, show_healthFacility_json, show_appointment_json, create_appointment, delete_appointment, show_registered_patient_page
